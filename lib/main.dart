  ...
  final _router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => CharacterDetailScreen(characterId: state.params['characterId'] ?? ''),
      ),
      GoRoute(
        path: EpisodeDetailScreen.route,
        name: EpisodeDetailScreen.route,
        builder: (context, state) => EpisodeDetailScreen(episodeId: state.params['episodeId'] ?? ''),
      ),
      GoRoute(
        path: LocationDetailScreen.route,
        name: LocationDetailScreen.route,
        builder: (context, state) => LocationDetailScreen(locationId: state.params['locationId'] ?? ''),
      ),
      GoRoute(
